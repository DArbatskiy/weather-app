    ...
    <div className={css.highlightsCards}>
      <div className={css.highlightsCard}>
        ...
        <div className={css.number}>
          {current.wind_mph}
          <span className={css.designation}>mph</span>
        </div>
        <div>WSW</div>
      </div>
      <div className={css.highlightsCard}>
        ...
        <div className={css.number}>
          {current.humidity}
          <span className={css.designation}>%</span>
        </div>
        <meter
          className={css.meter}
          min="0"
      ...
      <div className={css.highlightsCard}>
        ...
        <div className={css.number}>
          {current.vis_miles}
          <span className={css.designation}>miles</span>
        </div>
      </div>
      <div className={css.highlightsCard}>
        ...
        <div className={css.number}>
          {current.pressure_mb}
          <span className={css.designation}>mb</span>
        </div>
      </div>
    </div>
  );
