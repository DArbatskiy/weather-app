...
export const SearchLayout = () => {
  ...
  const cityHistory = useAppSelector(
    (state) => state.currentCity.search_history
  );
  const dispatch = useAppDispatch();
  const [fetchCities, { isLoading: citiesLoading, data: cities }] =
    useLazySearchByCityQuery();
    ...
    <div className={css.search}>
      <div className={css.closeButtonWrapper}>
        <button
          ...
          onClick={() => dispatch(searchIsClose())}
        ></button>
      </div>
